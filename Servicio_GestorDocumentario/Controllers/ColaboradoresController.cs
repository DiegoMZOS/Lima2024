...
namespace Servicio_GestorDocumentario.Controllers
{
    public class ColaboradoresController : Controller
    {
        ...
        [HttpGet("GetAllColaboradores/{IdColaborador}")]
        public async Task<IActionResult> GetAllColaboradores(int IdColaborador)
        {
            var colaboradores = await _colaboradorService.GetColaboradoresAsync(IdColaborador);
